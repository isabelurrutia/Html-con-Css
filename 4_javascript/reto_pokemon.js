...
*/
for (var i = 0; i < pokemon.length; i++) {  // Recorre el arreglo pokemon
    var p = pokemon[i];  // Guarda el pokemon actual en una variable
    if (p.types.length === 1 && p.types[0] === "poison") {  // Verifica si tiene solo un tipo y es "poison"
        console.log(p.name);  // Imprime el nombre del pokemon
    }
}